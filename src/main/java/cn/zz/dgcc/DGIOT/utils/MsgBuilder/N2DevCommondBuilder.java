...
public class N2DevCommondBuilder extends CommondBuild {
    ...
    static String n2DevStatus = new String("03 03 00 3A 00 01 A5 E5");
    static String n2Purity = new String("03 03 00 41 00 02 95 FD");
    static String n2Flow = new String("03 03 00 43 00 02 34 3D");
    static String n2Pressure = new String("03 03 00 45 00 02 D4 3C ");
    static String n2Temp = new String("03 03 00 47 00 02 75 FC");
