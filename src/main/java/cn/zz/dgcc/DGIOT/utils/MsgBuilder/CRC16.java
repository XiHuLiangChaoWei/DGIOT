...
public class CRC16 {
    ...
    public static int calcCrc16(byte[] data, int offset, int len, int preval) {
        //取得preval高八位  11111111
        int ucCRCHi = (preval & 0xff00) >> 8;
        //取得preval低八位   11111111
    ...
    public static String makeChecksum(String hexdata) {
        ...
        return BytesUtil.toHexString(total % 256);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(makeChecksum("AA A0 18 08 23 16 55 36 00 FF A2 FF FF FF FF FF FF FF FF FF FF FF FF FF FF"));
