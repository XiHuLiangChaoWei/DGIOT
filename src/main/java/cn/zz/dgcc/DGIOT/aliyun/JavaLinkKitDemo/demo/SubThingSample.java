...
public class SubThingSample extends BaseSample{
    ...
    private final IConnectNotifyListener connectNotifyListener = new IConnectNotifyListener() {
...
//                    aResponse.data =
    ...
    private final ITResRequestHandler mCommonHandler = new ITResRequestHandler() {
